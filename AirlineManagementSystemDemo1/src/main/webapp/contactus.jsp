...
function isFirstname(firstname) {
	...
	function isMessage(message) {
		return /^[A-Za-z0-9. ]{4,150}$/.test(message);
	}
	</script>
</head>
<body>
...
<div class="container">
<form action="contactusdb.jsp" method="post" class="form"  id="form" name="myForm" onsubmit="return checkInputs()">
<div class="form-control">
			<label for="firstname">First Name</label><br>
			<input style="width: 100%" type="text" placeholder="Enter Your First Name" id="firstname" name="firstname" /><br>
			<small>Error message</small>
		</div>
		<div class="form-control">
			<label for="lastname">Last Name</label><br>
			<input style="width: 100%" type="text" placeholder="Enter Your Last Name" id="lastname" name="lastname" /><br>
			<small>Error message</small>
		</div>
		<div class="form-control">
